...
const GLOBAL_ACTIONS = {
  ...
  //
  // Phase 5C : notifications_create/update/delete/test sont désormais
  // vérifiées par lib/routes/notifications.js (CRUD complet des providers +
  // test). notifications_history et notifications_manage restent déclarées
  // mais pas encore utilisées par une route — prévues respectivement pour
  // l'historique détaillé et le routing (Phase 5D/5E).
  //

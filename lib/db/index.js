...
module.exports = {
  ...
  // Transactions : utilisées principalement par le système de migrations
  // (lib/db/migrator.js). Voir les commentaires des drivers pour les limites
  // (DDL non transactionnel sous MySQL/InnoDB).
  beginTransaction: (...args) => impl.beginTransaction(...args),
  commit: (...args) => impl.commit(...args),
  rollback: (...args) => impl.rollback(...args),
  supportsTransactionalDDL: !!impl.supportsTransactionalDDL,
  driver: impl.driver,
};

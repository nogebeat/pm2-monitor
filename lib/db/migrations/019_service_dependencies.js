...
async function up(db) {
  if (db.driver === "mysql") {
    ...
    await db.run("CREATE INDEX IF NOT EXISTS idx_service_dependencies_source ON service_dependencies(source)");
    await db.run("CREATE INDEX IF NOT EXISTS idx_service_dependencies_target ON service_dependencies(target)");
    await db.run(

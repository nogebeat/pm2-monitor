...
// "silenced" (Phase 14 — Incident Management & Alert Silencing) : la route
// matchait, mais un silence actif (lib/services/incidents/silence-store.js)
// a empêché l'envoi — voir routing/engine.js#dispatch. Distinct de "failed"
// (échec réel d'un provider) : un silence est une décision délibérée de
// l'opérateur, pas un problème d'infrastructure.
const VALID_STATUSES = ["pending", "retrying", "success", "failed", "silenced"];

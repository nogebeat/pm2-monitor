 ...
 * interne (Phase 5C : lib/routes/notifications.js l'utilise uniquement pour
 * POST /providers/:id/test et pour fusionner les secrets existants lors
 * d'une modification partielle — jamais renvoyé tel quel dans une réponse
 * HTTP).
 */
...
async function update(id, changes) {
  ...
  const merged = {
    ...
    secrets: changes.secrets !== undefined ? secretsCrypto.encrypt(changes.secrets) : existing.secrets,
  };

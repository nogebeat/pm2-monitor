 ...
 * clé (notamment `server`/`tag`, qui n'ont pas encore d'équivalent dans le
 * modèle d'alerte actuel — moniteur mono-hôte, alertes sans tag).
 *
...
function validate(input, { partial = false } = {}) {
  ...
  if (
    ...
    typeof input.messageTemplate !== "string"
  ) {

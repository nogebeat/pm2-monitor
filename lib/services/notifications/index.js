 ...
 * Notification Manager et les stores, et enregistre les providers réels
 * (providers/index.js, Phase 5B). Instance partagée par
 ...
 * implémenté à ce stade (Phase 5B : providers ; routing/queue/Alert Engine
 * en Phase 5C).
 */

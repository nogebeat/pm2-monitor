 ...
 * `severity` est modifiable ici (pas seulement à la création) pour permettre
 * l'escalade dynamique de sévérité d'une détection d'anomalie pendant
 * qu'elle reste ouverte — voir lib/services/anomaly-detection/service.js.
 * L'engine lui-même (engine.js) ne l'utilise jamais pour ce champ.
 */

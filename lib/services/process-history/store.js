...
function rowToRollupPoint(row) {
  return {
    ...
    heapTotal: {
      avg:
        row.heap_total_avg !== null && row.heap_total_avg !== undefined ? Number(row.heap_total_avg) : null,
      min:
        row.heap_total_min !== null && row.heap_total_min !== undefined ? Number(row.heap_total_min) : null,
      max:
        row.heap_total_max !== null && row.heap_total_max !== undefined ? Number(row.heap_total_max) : null,
      p95:
        row.heap_total_p95 !== null && row.heap_total_p95 !== undefined ? Number(row.heap_total_p95) : null,
    },
    eventLoopLag: {
      avg:
    ...
    onlineCount:
      row.online_count !== null && row.online_count !== undefined ? Number(row.online_count) : null,
